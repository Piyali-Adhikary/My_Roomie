...
import in.objectsol.my_roomie.Activity.Warden_Request_Approvals;
...
public class Warden_Request_Approval_Student_List_Adapter extends RecyclerView.Adapter<Warden_Request_Approval_Student_List_Adapter.MyViewHolder> {
    ...
    public Warden_Request_Approval_Student_List_Adapter(Context mContext, ArrayList<Student_SetGet> list) {
       ...
       // student_id=list.get(position).getStudent_id();
        ...
        holder.cv_child_student_list.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Warden_Request_Approvals.student_id=list.get(position).getStudent_id();
                Intent intent= new Intent(mContext, Warden_Request_Approvals.class);

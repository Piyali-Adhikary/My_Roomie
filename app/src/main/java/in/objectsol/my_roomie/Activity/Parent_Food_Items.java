...
public class Parent_Food_Items extends Activity implements IJSONParseListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(Parent_Food_Items.this,MainActivity.class);
        ...
        if (Utils.isNetworkAvailable(Parent_Food_Items.this)) {

            viewFoodMenu();

        }
        else {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Parent_Food_Items.this);
    ...
    void viewFoodMenu() {
        JSONRequestResponse mResponse = new JSONRequestResponse(Parent_Food_Items.this);
        ...
        MyVolley.init(Parent_Food_Items.this);
        ShowProgressDilog(Parent_Food_Items.this);
        mResponse.getResponse(Request.Method.POST, View_Food_Menu_URL, viewFoodMenu, Parent_Food_Items.this, parms, false);
    }

    @Override
    public void ErrorResponse(VolleyError error, int requestCode) {

        DismissProgress(Parent_Food_Items.this);
        ...
        if (requestCode == viewFoodMenu) {
            ...
            try {
                ...
                if (response.getString("status_code").equalsIgnoreCase("success")) {
                    ...
                    Food_Items_Adapter food_items_adapter=new Food_Items_Adapter(Parent_Food_Items.this,dayList);
                    rv_food_items.setAdapter(food_items_adapter);
                }else {
                    Toast.makeText(Parent_Food_Items.this,response.getString("result"),Toast.LENGTH_LONG).show();
                }
            }

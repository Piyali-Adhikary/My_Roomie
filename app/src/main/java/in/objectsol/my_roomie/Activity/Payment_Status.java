...
public class Payment_Status extends Activity  implements IJSONParseListener{
    ...
    private static final String View_Payment_Status_URL = "http://174.136.1.35/dev/myroomie/student/viewPaymentStatus/";
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        iv_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent=new Intent(Payment_Status.this,MainActivity.class);
        ...
        if (Utils.isNetworkAvailable(Payment_Status.this)) {

            viewPaymentStatus();

        }
        else {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Payment_Status.this);
    ...
    void viewPaymentStatus() {
        JSONRequestResponse mResponse = new JSONRequestResponse(Payment_Status.this);
        ...
        MyVolley.init(Payment_Status.this);
        ShowProgressDilog(Payment_Status.this);
        mResponse.getResponse(Request.Method.POST, View_Payment_Status_URL, viewPaymentStatus, Payment_Status.this, parms, false);
    }

    @Override
    public void ErrorResponse(VolleyError error, int requestCode) {

        DismissProgress(Payment_Status.this);
        ...
        if (requestCode == viewPaymentStatus) {
            ...
            try {
                ...
                if (response.getString("status_code").equalsIgnoreCase("success")) {
                    ...
                    Payment_Status_Adapter adapter=new Payment_Status_Adapter(Payment_Status.this,payment_setGetArrayList);
                    rv_payment_status.setAdapter(adapter);

                }else {
                    Toast.makeText(Payment_Status.this,response.getString("result"),Toast.LENGTH_LONG).show();
                }
            }

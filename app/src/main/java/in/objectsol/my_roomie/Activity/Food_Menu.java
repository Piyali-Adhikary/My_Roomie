...
public class Food_Menu extends Activity implements IJSONParseListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ArrayAdapter arrayAdapter=new ArrayAdapter(Food_Menu.this,android.R.layout.simple_list_item_1,day_setGetArrayList);
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(dayList.size()>0){
                    ...
                    for(int j=0;j<dayList.size();j++){
                        if(dayList.get(j).getDayname().equalsIgnoreCase(Food_Menu.spinner_selection)){
                    ...
                    Food_Menu_Adapter food_items_adapter=new Food_Menu_Adapter(Food_Menu.this,dayList1);
        ...
        if (Utils.isNetworkAvailable(Food_Menu.this)) {

            viewFoodMenu();

        }
        else {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Food_Menu.this);
    ...
    void viewFoodMenu() {
        JSONRequestResponse mResponse = new JSONRequestResponse(Food_Menu.this);
        ...
        MyVolley.init(Food_Menu.this);
        ShowProgressDilog(Food_Menu.this);
        mResponse.getResponse(Request.Method.POST, View_Food_Menu_URL, viewFoodMenu, Food_Menu.this, parms, false);
    }

    @Override
    public void ErrorResponse(VolleyError error, int requestCode) {

        DismissProgress(Food_Menu.this);
            ...
            try {
                ...
                if (response.getString("status_code").equalsIgnoreCase("success")) {
                    ...
                    for(int i=0;i<dayList.size();i++){
                        if(dayList.get(i).getDayname().equalsIgnoreCase(Food_Menu.spinner_selection)){
                    ...
                    Toast.makeText(Food_Menu.this,response.getString("result"),Toast.LENGTH_LONG).show();
                }
            }

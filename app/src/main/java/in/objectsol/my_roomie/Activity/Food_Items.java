...
public class Food_Items extends Activity implements IJSONParseListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (Utils.isNetworkAvailable(Food_Items.this)) {

            viewFoodMenu();

        }
        else {
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Food_Items.this);
    ...
    void viewFoodMenu() {
        JSONRequestResponse mResponse = new JSONRequestResponse(Food_Items.this);
        ...
        MyVolley.init(Food_Items.this);
        ShowProgressDilog(Food_Items.this);
        mResponse.getResponse(Request.Method.POST, View_Food_Menu_URL, viewFoodMenu, Food_Items.this, parms, false);
    }

    @Override
    public void ErrorResponse(VolleyError error, int requestCode) {

        DismissProgress(Food_Items.this);
        ...
        if (requestCode == viewFoodMenu) {
            ...
            try {
                ...
                if (response.getString("status_code").equalsIgnoreCase("success")) {
                    ...
                    Food_Items_Adapter food_items_adapter=new Food_Items_Adapter(Food_Items.this,dayList);
                    rv_food_items.setAdapter(food_items_adapter);
                }else {
                    Toast.makeText(Food_Items.this,response.getString("result"),Toast.LENGTH_LONG).show();
                }
            }

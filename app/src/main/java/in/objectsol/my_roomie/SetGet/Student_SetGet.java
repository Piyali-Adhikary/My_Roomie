...
public class Student_SetGet {
    ...
    public String getPrivacy_permission_status() {
        return privacy_permission_status;
    }

    public void setPrivacy_permission_status(String privacy_permission_status) {
        this.privacy_permission_status = privacy_permission_status;
    }
